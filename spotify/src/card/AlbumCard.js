...
//Structure de la carte de l'artiste
const AlbumCard = ({ name, photo, artist }) => {
  return (
    <div className="bg-gray-800 hover:bg-gray-700 transition duration-300 rounded-lg p-4 shadow-lg text-center cursor-pointer">
      ...
      />
      <h2 className="text-white text-lg font-semibold mt-3 truncate">{name}</h2>
      <h3 className="text-white text-lg font-semibold mt-3 truncate"> {artist}</h3>
    </div>
  );
};
